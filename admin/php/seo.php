...
<img src="../assets/img/<?=$data2['icon']?>" class="img-thumbnail ooo">
  </div>
  ...
  <div class="custom-file">
   ...
   <div class="form-group col-md-6 mt-auto">
      ...
      <input type="name" name="title" value="<?=$data2['title']?>" class="form-control" id="name" placeholder="Mohan Goswami">
    </div>
    ...
    <div class="form-group col-md-12">
      ...
      <input type="text" name="keywords" value="<?=$data2['keyword']?>" class="form-control" id="email" placeholder="web developer,php developer,graphic designer,freelancer">
    </div>
    <div class="form-group col-md-12">
      <label for="email">Site Description (160 Characters recommended)</label>
      <input type="text" value="<?=$data2['description']?>" name="description" class="form-control" id="email" placeholder="this is portfolio website">
    </div>
