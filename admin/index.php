...
$query="SELECT * FROM personal_setup where faculty_id='$_SESSION[id]'";
$query1="SELECT * FROM aboutus_setup where faculty_id='$_SESSION[id]'";
$query2="SELECT * FROM basic_setup where faculty_id='$_SESSION[id]'";
$query3="SELECT * FROM admin_users where id='$_SESSION[id]'";
$queryrun=mysqli_query($db,$query);
$queryrun1=mysqli_query($db,$query1);
$queryrun2=mysqli_query($db,$query2);
$queryrun3=mysqli_query($db,$query3);
$data=mysqli_fetch_array($queryrun);
$data1=mysqli_fetch_array($queryrun1);
$data2=mysqli_fetch_array($queryrun2);
$data3=mysqli_fetch_array($queryrun3);
?>
<!doctype html>
<html lang="en">
  <head>
      ...
      <div class="sidebar-sticky pt-3">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="?course=true">
...
?> 
    ...
    <input type="text" name="username" value="<?=$data3['username']?>" class="form-control" id="ptitle" placeholder="Monu Giri">
  </div>
        <div class="form-group col-md-6">
    <label for="psubtitle">Password</label>
    <input type="text" name="userpass" value="<?=$data3['user_pass']?>" class="form-control" id="psubtitle" placeholder="*************">
  </div>
        <div class="form-group col-md-12">
    <label for="psubtitle">Email Id</label>
    <input type="text" name="userid" value="<?=$data3['user_id']?>" class="form-control" id="psubtitle" placeholder="admin@admin.com">
  </div>
         </div>
